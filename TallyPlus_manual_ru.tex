...
\begin{document}
	...
	\sloppy
	Устройство предназначено для работы совместно с системными и 
	портативными камерами в аппаратно-студийных комплексах.
	\noindent Назначение: 
	\begin{itemize}
	...
	\begin{center}
		\begin{tabular}{|m{0.02\textwidth}|m{0.4\textwidth}|m{0.22\textwidth}|m{0.23\textwidth}|} \hline
