...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=8cm]{imgs/iso_left_1.png}
		\includegraphics[width=8cm]{imgs/iso_right_1.png}
	\end{figure}
	...
	\begin{center}
		\begin{tabular}{|p{0.1\textwidth}|p{0.4\textwidth}|p{0.5\textwidth}|} \hline
			...
			10 & Размер (ШхВхГ), мм & 69x92x45 (TallyPlus), 120x92x45 (TallyPlus Dual Digit) \\ \hline
			11 & Вес, гр & 170 (TallyPlus), 250 (TallyPlus Dual Digit) \\ \hline
		\end{tabular}
	\end{center}	
	...
	\section{Порядок работы}
		\begin{enumerate}
			...
			\item При режиме работы с датчиком LDR (фоторезистор), с помощью регулятора чувствительности, размещенного на боковой
			стороне настроить порог переключения цвета индикации.
