...
\begin{document}
	...
	\begin{titlepage} % Титульный лист
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=8cm, keepaspectratio]{imgs/title.png}
		\end{figure}
	...
	\begin{center}
		\begin{tabular}{|p{0.02\textwidth}|p{0.3\textwidth}|p{0.65\textwidth}|} \hline
			...
			10 & Размер (ШхВхГ), мм & 69x92x45 (TallyPlus),
			                          \newline 120x92x45 (TallyPlus Dual Digit) \\ \hline
			11 & Размер упаковки (ШхВхГ), мм & 116x103x102 \\ \hline
			12 & Вес, гр & 170 (TallyPlus),
			               \newline 250 (TallyPlus Dual Digit) \\ \hline
			13 & Вес с упаковкой, гр & 500 (TallyPlus),
			                           \newline 580 (TallyPlus Dual Digit) \\ \hline
	...
	\begin{center}
		\begin{tabular}{|p{0.02\textwidth}|p{0.4\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|} \hline
